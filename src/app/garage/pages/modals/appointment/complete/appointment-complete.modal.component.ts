...
@Component({
  selector: 'mean-mechanics-complete-modal',
  imports: [
    FormsModule,
    MatFormField,
    MatInput,
  ...
  templateUrl: './appointment-complete.modal.component.html',
  styleUrl: './appointment-complete.modal.component.css'
})
export class AppointmentCompleteModalComponent {
  private readonly dialogRef = inject(MatDialogRef<AppointmentCompleteModalComponent>);

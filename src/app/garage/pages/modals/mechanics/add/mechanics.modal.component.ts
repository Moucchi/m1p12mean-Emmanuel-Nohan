...
@Component({
  ...
  templateUrl: './mechanics.modal.component.html',
  styleUrl: './mechanics.modal.component.css'
})
export class MechanicsModalComponent {
  readonly dialogRef = inject(MatDialogRef<MechanicsModalComponent>);
